...
const sourceTaskIdSchema = z.uuid({
...
const taskTemplateBaseSchema = z.object({
  name: nameSchema,
  sourceTaskId: sourceTaskIdSchema.optional(),
  title: titleSchema,
...
export const createTaskTemplateSchema = taskTemplateBaseSchema.superRefine(
  checkRepeatFields("template"),
);
